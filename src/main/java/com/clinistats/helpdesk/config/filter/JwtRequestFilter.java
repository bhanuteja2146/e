...
public class JwtRequestFilter extends BasicAuthenticationFilter {
	...
	public JwtRequestFilter(AuthenticationManager authManager, JwtTokenUtil jwtTokenUtils,
			UserDetailsServiceImpl userDetailsService2, TokenService tokenService2) {
		super(authManager);
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		Optional<BlackListedTokens> tokens = tokenService.getToken(jwtToken);
		if (!tokens.isPresent()) {
